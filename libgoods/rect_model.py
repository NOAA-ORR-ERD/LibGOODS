...
class rect(base.nc):
    ...
    def write_nc(self,var_map,ofn='test.nc',t_index=None,d_index=0,is3d=False,grid_only=False,dl=0):
        '''
        Write a rectangular grid model file
        ...
        if dl == 0:
            var_out[:] = (lon > 180 ).choose(lon,lon-360)
        else:
